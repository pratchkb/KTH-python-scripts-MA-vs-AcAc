...
if __name__ == "__main__":
    ...
    for nstate in range(3,6):
        data = np.genfromtxt('/data/projects/Pratip_MA_vs_AcAc/AcAc-data/state_averaging_test_IC110/SA' + str(nstate) + '-realshift-new/final-result-au-nm.dat', dtype='float')
    ...
    fig.savefig('TRAJ110-testing-updated-realshift1412.pdf', dpi=500)
