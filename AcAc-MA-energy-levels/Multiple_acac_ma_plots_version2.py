...
if __name__ == '__main__' and len(sys.argv) > 0:
    structure_order = ['FC','Asym HTI','Sym HTI', 'S2/S1 tw', 'S1 min', 'T1 min', 'S1/S0 tw']
    labels = [r'S$_0$-min', r'S$_2$/S$_1$-asym-HTI', r'S$_2$/S$_1$-sym-HTI', r'S$_2$/S$_1$-tw', r'S$_1$-min', r'T$_1$-min', r'S$_1$/S$_0$-tw'] 
...
#            legend_names.append("{} {}".format(arg.split('.')[0], state)) 
        ...
        ax.axhline(y=4.799,color='gray', linestyle='--', zorder=1, lw=0.6)
    ...
    plt.tight_layout()
    plt.savefig('MA_relative_energy_plot_test_all_version1.pdf', dpi=1000,transparent=True)
