...
if __name__ == '__main__' and len(sys.argv) > 0:
    structure_order = ['S0','S21NTpyr','S1min', 'S10N']
    labels = [r'S$_0$-min', r'S$_2$/S$_1$-MECI-NT$_{pyr}$', r'S$_1$-min', r'S$_1$/S$_0$-MECI-N'] 

    fig = plt.figure(figsize=(6,8))
    names = [name.split('.')[0] for name in sys.argv[1:]]
    legend_names = [r'S$_0$', r'S$_1$', r'S$_2$']
...
#            legend_names.append("{} {}".format(arg.split('.')[0], state)) 
        ...
        ax.axhline(y=((-191.64283883)-(-191.76162182))*au2ev,color='gray', linestyle='--', zorder=1, lw=0.6)
        ax.axhline(y=((-191.50758355)-(-191.76162182))*au2ev, color='lightgray',linestyle='--',zorder=2,lw=0.6)
    ...
    plt.tight_layout()
    plt.savefig('methylatedAC_relative_energy_plot_test_all_version2.pdf', dpi=1000,transparent=True)
