...
if __name__ == '__main__' and len(sys.argv) > 0:
    structure_order = ['FC','Asym HTI down','Asym HTI stag','Sym HTI down','Asym HTI up', 'Sym HTI down', 'S2/S1 tw', 'S1 min', 'T1 min', 'S1/S0 CIpy', 'S1/S0 tw']
    labels = [r'S$_0$-min', r'Asym-HTI-Edown', r'Asym-HTI-Eup', r'sym-HTI-Edown', r'Asym-HTI-Eup', r'Sym-HTI-Eup', r'Tw', r'S$_1$-min', r'T$_1$-min', r'CIpy', r'Tw'] 
...
#            legend_names.append("{} {}".format(arg.split('.')[0], state)) 
        ...
        ax.axhline(y=4.726,color='gray', linestyle='--', zorder=1, lw=0.6)
        ax.axhline(y=3.668, color='lightgray',linestyle='--',zorder=2,lw=0.6)
    ...
    plt.tight_layout()
    plt.savefig('AcAc_relative_energy_plot_test_all_version1.pdf', dpi=1000,transparent=True)
