...
if __name__ == "__main__":
    ...
    path = "/data/projects/Pratip_MA_vs_AcAc/MA-data/MA-QT/QT1/collect-version2/total/KineticE/"
    pathscript = "/data/projects/Pratip_MA_vs_AcAc/PLOTS/SI/FIGURE-S6/"

    os.chdir(path)
    list_file = ['pulse-total-0.24-vel.xyz', 'total-velocities-120fs-all-correct.xyz', 'combined-vel-movie.xyz']
    ...
    for file in list_file:
        ...
        plt.figure()
        plt.hist(KE_list, bins=30, range=[0.0,3.5], density=True, weights=None, color = 'orange', alpha = 0.9)
        ...
        plt.tight_layout()
        plt.savefig(pathscript + str(file) + '.pdf',dpi=300)
