...
if __name__ == "__main__":
    ...
    path_script = '/data/projects/Pratip_MA_vs_AcAc/PLOTS/SI/FIGURE-S11/Population/ALL-traj-no-discard/'
    ...
    for molecule in molecules:
        ...
        plt.tight_layout()
        plt.savefig(path_script + f'population_{molecule}_alltraj_nodiscard.pdf', dpi=500)
